...
// Do not replace the app's global render function. A document-level hook keeps
// PDF Study Mode isolated so a failure here cannot break the rest of Liam's site.
...
const observer=new MutationObserver(()=>{try{injectButton()}catch(err){console.error('PDF Study Mode button:',err)}});
